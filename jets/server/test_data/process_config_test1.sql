...
INSERT INTO process_input (process_key, input_table, entity_rdf_type, grouping_column) VALUES
  (1, 'test1', 'acme:Claim', 'header1'),
  (2, 'm2c__input1', 'm2c:Claim', 'COL2')
;

INSERT INTO process_mapping (process_input_key, input_column, data_property, function_name, argument, default_value) VALUES
  (1, 'header1', 'acme:P1', 'regex', '\d{3}', NULL),
  (1, 'header2', 'acme:P2', NULL, NULL, NULL),
  (1, 'header3', 'acme:P3', 'parse_amount', '100', '0'),
...
INSERT INTO rule_config (process_key, subject, predicate, object, rdf_type) VALUES
  (1, 'subject1', 'predicate1', 'object1', 'resource'),
  (1, 'subject1', 'predicate2', 'object2', 'resource'),
