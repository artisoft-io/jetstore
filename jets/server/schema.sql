...
-- 2023/02/12 22:05:34 Here's what we got:
-- 2023/02/12 22:05:34    -awsDsnSecret: rdsSecret9F108BD1-L4s4KvRKqM6h
-- 2023/02/12 22:05:34    -dbPoolSize: 5
-- 2023/02/12 22:05:34    -usingSshTunnel: true
-- 2023/02/12 22:05:34    -dsn len: 0
-- 2023/02/12 22:05:34    -jetsapiDbInitPath: /home/michel/projects/repos/artisoft-workspaces/walrus_ws/process_config/workspace_init_db.sql
-- 2023/02/12 22:05:34    -workspaceDb: /home/michel/projects/repos/artisoft-workspaces/walrus_ws/workspace.db
-- 2023/02/12 22:05:34    -migrateDb: true
-- 2023/02/12 22:05:34    -initWorkspaceDb: false
-- 2023/02/12 22:05:34 ENV JETSAPI_DB_INIT_PATH: /home/michel/projects/repos/artisoft-workspaces/walrus_ws/process_config/workspace_init_db.sql
-- 2023/02/12 22:05:34 ENV WORKSPACE_DB_PATH: /home/michel/projects/repos/artisoft-workspaces/walrus_ws/workspace.db
-- LOCAL TESTING using ssh tunnel (expecting ssh tunnel open)
-- 2023/02/12 22:05:35 Migrating jetsapi database to latest schema
...
CREATE SCHEMA IF NOT EXISTS "jetsapi"
DROP TABLE IF EXISTS "jetsapi"."client_org_registry"
CREATE TABLE IF NOT EXISTS "jetsapi"."client_org_registry"(
"client" text NOT NULL ,
"org" text NOT NULL ,
"details" text,
CONSTRAINT client_org_registry_unique_cstraint UNIQUE (client, org));
...
CREATE SCHEMA IF NOT EXISTS "jetsapi"
DROP TABLE IF EXISTS "jetsapi"."source_period"
CREATE TABLE IF NOT EXISTS "jetsapi"."source_period"(
"key"  SERIAL PRIMARY KEY ,
"year" integer NOT NULL ,
"month" integer NOT NULL ,
"day" integer NOT NULL ,
"month_period" integer NOT NULL ,
"week_period" integer NOT NULL ,
"day_period" integer NOT NULL ,
CONSTRAINT source_period_unique_cstraint UNIQUE (year, month, day));
...
"source_period_key" integer NOT NULL ,
"last_update" timestamp without time zone DEFAULT now() NOT NULL ,
CONSTRAINT file_key_staging_unique_cstraint UNIQUE (file_key));
...
"last_update" timestamp without time zone DEFAULT now() NOT NULL ,
CONSTRAINT source_config_unique_cstraint1 UNIQUE (table_name),
CONSTRAINT source_config_unique_cstraint2 UNIQUE (client, org, object_type));
...
"user_email" text NOT NULL ,
"last_update" timestamp without time zone DEFAULT now() NOT NULL ,
CONSTRAINT input_registry_unique_cstraintv2 UNIQUE (client, org, object_type, table_name, session_id));
...
"user_email" text NOT NULL ,
"last_update" timestamp without time zone DEFAULT now() NOT NULL ,
CONSTRAINT process_input_unique_cstraintv2 UNIQUE (client, org, object_type, table_name));
...
"source_period_type" text DEFAULT 'month' NOT NULL ,
"lookback_periods" integer DEFAULT 0 NOT NULL ,
"automated" integer DEFAULT 0 NOT NULL ,
"description" text,
"user_email" text NOT NULL ,
"last_update" timestamp without time zone DEFAULT now() NOT NULL );
...
2023/02/12 22:05:38 Create / Update JetStore Domain Tables
2023/02/12 22:05:38 Opening workspace database...
2023/02/12 22:05:38 Reading table wrs:ClaimFillSummary info...
2023/02/12 22:05:38 Reading table wrs:ClinicalOpportunityTest1 info...
2023/02/12 22:05:38 Reading table wrs:Eligibility info...
2023/02/12 22:05:38 Reading table wrs:PharmacyClaim info...
