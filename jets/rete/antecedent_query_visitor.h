...
struct AQVInitializeIndexesVisitor: public boost::static_visitor<>
{
  ...
  void operator()(I const&, I const&, I const&){ this->node_vertex->antecedent_query_key = this->add_query3(); VLOG(1)<<"Q3 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(O const&, I const&, I const&){ this->node_vertex->antecedent_query_key = this->add_query2();VLOG(1)<<"Q2 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(O const&, O const&, I const&){ this->node_vertex->antecedent_query_key = this->add_query1();VLOG(1)<<"Q1 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(O const&, O const&, O const&){ }
  void operator()(I const&, O const&, I const&){ this->node_vertex->antecedent_query_key = this->add_query2();VLOG(1)<<"Q2 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(I const&, O const&, O const&){ this->node_vertex->antecedent_query_key = this->add_query1();VLOG(1)<<"Q1 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(I const&, I const&, O const&){ this->node_vertex->antecedent_query_key = this->add_query2();VLOG(1)<<"Q2 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
  void operator()(O const&, I const&, O const&){ this->node_vertex->antecedent_query_key = this->add_query1();VLOG(1)<<"Q1 parent beta row vertex "<<this->beta_relation->node_vertex_->vertex<<" | Child NodeVertex "<<this->node_vertex->vertex<<", antecedent_query_key "<<this->node_vertex->antecedent_query_key<<">";}
