...
var sqlInsertStmts = map[string]*SqlInsertDefinition{
	...
	"source_config": {
		Stmt: `INSERT INTO jetsapi.source_config 
			...
			RETURNING key`,
		ColumnKeys: []string{"object_type", "client", "org", "table_name", "domain_keys_json", "code_values_mapping_json", "input_columns_json", "input_columns_positions_csv", "input_format", "is_part_files", "input_format_data_json", "domain_keys", "compute_pipes_json", "user_email"},
		Capability: "client_config",
	},
	"update/source_config": {
		...
		ColumnKeys: []string{"object_type", "client", "org", "table_name", "domain_keys_json", "code_values_mapping_json", "input_columns_json", "input_columns_positions_csv", "input_format", "is_part_files", "input_format_data_json", "domain_keys", "compute_pipes_json", "user_email", "key"},
		Capability: "client_config",
	},
