...
class JetRulesLookupLoaderTest(absltest.TestCase):
  ...
  def test_basic_lookup_load(self):
    ...
    basic_table = lookup_loader.get_lookup(table_name='acme:BA__SIC', lookup_db = "lookup_loader_test_lookup.db")
  ...
  def test_composite_lookup_load(self):
    ...
    composite_table = lookup_loader.get_lookup(table_name='acme:COMPOSITE', lookup_db = "lookup_loader_test_lookup.db")
