...
func RDFSessionAsTable(rdfSession *bridgego.RDFSession, limit int) *map[string]interface{} {
	if rdfSession == nil {
		return nil
	}
...
func RDFSessionAsTableJson(rdfSession *bridgego.RDFSession, limit int) []byte {
...
func RDFSessionAsTableV2(rdfSession *bridgego.RDFSession, js *bridgego.JetStore) (*map[string]interface{}, error) {
	if rdfSession == nil {
	...
	// Set of entity
	entitySet := make(map[string]*bridgego.Resource)
...
func RDFSessionAsTableJsonV2(rdfSession *bridgego.RDFSession, js *bridgego.JetStore) ([]byte, error) {
