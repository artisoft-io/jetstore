...
class ChannelSpec(_Base):
    ...
    domain_keys: dict[str, Any] | None = Field(default=None, description="DomainKeys provide the ability to configure the domain keys in the cpipes config document.")
...
class InputChannelConfigInput(InputChannelConfigBase):
    ...
    domain_keys: dict[str, Any] | None = Field(default=None, description="Domain key configuration for the records.")
...
class OllamaSpec(_Base):
    ...
    response_format: Any | None = Field(default=None, description="Passed to ollama as format: the string \"json\" or a json schema.")
...
class PromptTemplateSpec(_Base):
    ...
    response_format: Any | None = Field(default=None, description="Default response format for operators using this template.")
...
class SchemaProviderSpecDefault(SchemaProviderSpecBase):
    ...
    env: dict[str, Any] | None = Field(default=None, description="Env vars made available to the pipeline.")
    eol_byte: int | None = Field(default=None, description="EolByte: Byte to use as eol (format: csv,headerless_csv).")
