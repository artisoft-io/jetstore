...
import 'package:jetsclient/modules/user_flows/home_filters/form_config.dart';
...
/// Every key _formConfigurations holds — the screens outside the user flows.
///
...
Iterable<String> get screenFormConfigKeys => _formConfigurations.keys;
...
FormConfig getFormConfig(String key) {
  ...
  if (config != null) return config;
  config = getHomeFiltersFormConfig(key);
  if (config != null) return config;
