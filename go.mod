...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v54 v54.20.0 // indirect
...
require (
	...
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.266.0-alpha.0
