...
require (
	...
	github.com/cdklabs/cloud-assembly-schema-go/awscdkcloudassemblyschema/v44 v44.5.0 // indirect
...
require (
	...
	github.com/aws/aws-cdk-go/awscdklambdagoalpha/v2 v2.201.0-alpha.0
