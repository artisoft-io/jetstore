...
class JetRulesCompilerTest(absltest.TestCase):
  ...
  def test_import1(self):
    ...
    expected = """{"literals": [{"type": "int", "id": "isTrue", "value": "1"}, {"type": "text", "id": "NOT_IN_CONTRACT", "value": "NOT COVERED IN CONTRACT"}, {"type": "text", "id": "EXCLUDED_STATE", "value": "STATE"}], "resources": [{"id": "acme:ProcedureLookup", "type": "resource", "value": "acme:ProcedureLookup"}, {"id": "cPROC_RID", "type": "resource", "value": "PROC_RID"}, {"id": "cPROC_MID", "type": "resource", "value": "PROC_MID"}, {"id": "cPROC_DESC", "type": "resource", "value": "PROC_DESC"}], "lookup_tables": [{"name": "acme:ProcedureLookup", "table": "acme__cm_proc_codes", "key": ["PROC_CODE"], "columns": ["PROC_RID", "PROC_MID", "PROC_DESC"], "resources": ["cPROC_RID", "cPROC_MID", "cPROC_DESC"]}], "rete_nodes": [{"vertex": 0, "parent_vertex": 0, "label": "Head node", "children_vertexes": [], "consequent_nodes": []}]}"""
  ...
  def test_compiler1(self):
    ...
    optimized_expected = """{"literals": [], "resources": [{"type": "resource", "id": "rdf:type", "value": "rdf:type"}, {"type": "resource", "id": "acme:Claim", "value": "acme:Claim"}, {"type": "volatile_resource", "id": "is_good", "value": "is_good"}], "lookup_tables": [], "rete_nodes": [{"vertex": 0, "parent_vertex": 0, "label": "Head node", "children_vertexes": [1], "consequent_nodes": []}, {"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "children_vertexes": [2], "consequent_nodes": [], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x1", "label": "?clm01"}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "label": "(?clm01 rdf:type acme:Claim).[(?clm01 or true) and ?clm01]", "filter": {"type": "binary", "lhs": {"type": "binary", "lhs": {"type": "var", "id": "?x1", "label": "?clm01"}, "op": "or", "rhs": {"type": "keyword", "value": "true"}}, "op": "and", "rhs": {"type": "var", "id": "?x1", "label": "?clm01"}}, "vertex": 1, "parent_vertex": 0, "beta_relation_vars": ["?x1"], "pruned_var": []}}, {"vertex": 2, "parent_vertex": 1, "label": "(?x1 is_good ?x2)", "children_vertexes": [], "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "id": "?x1", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x1 is_good true)", "label": "(?clm01 is_good true)", "vertex": 2}], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x1", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "var", "id": "?x2", "label": "?good"}], "normalizedLabel": "(?x1 is_good ?x2)", "label": "(?clm01 is_good ?good)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x1"], "pruned_var": ["?x2"]}}]}"""
    # print()
  ...
  # "label": "[RuleC5]:(?clm03 rdf:type acme:Claim).(?clm01 rdf:type acme:Claim).(?clm01 reverse_of ?clm02).(?clm02 rdf:type acme:Claim) -> (?clm01 is_good true);"    
    ...
    optimized_data = jetrule_ctx.jetRules
    optimized_expected = """{"literals": [], "resources": [{"type": "resource", "id": "rdf:type", "value": "rdf:type"}, {"type": "resource", "id": "acme:Claim", "value": "acme:Claim"}, {"type": "volatile_resource", "id": "is_good", "value": "is_good"}], "lookup_tables": [], "rete_nodes": [{"vertex": 0, "parent_vertex": 0, "label": "Head node", "children_vertexes": [1], "consequent_nodes": []}, {"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim)", "children_vertexes": [2], "consequent_nodes": [], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x1", "label": "?clm03"}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim)", "label": "(?clm03 rdf:type acme:Claim)", "vertex": 1, "parent_vertex": 0, "beta_relation_vars": [], "pruned_var": ["?x1"]}}, {"vertex": 2, "parent_vertex": 1, "label": "(?x2 rdf:type acme:Claim)", "children_vertexes": [3], "consequent_nodes": [], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x2", "label": "?clm01"}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x2 rdf:type acme:Claim)", "label": "(?clm01 rdf:type acme:Claim)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1"]}}, {"vertex": 3, "parent_vertex": 2, "label": "(?x2 reverse_of ?x3)", "children_vertexes": [4], "consequent_nodes": [], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x2", "label": "?clm01"}, {"type": "identifier", "value": "reverse_of"}, {"type": "var", "id": "?x3", "label": "?clm02"}], "normalizedLabel": "(?x2 reverse_of ?x3)", "label": "(?clm01 reverse_of ?clm02)", "vertex": 3, "parent_vertex": 2, "beta_relation_vars": ["?x2", "?x3"], "pruned_var": ["?x1"]}}, {"vertex": 4, "parent_vertex": 3, "label": "(?x3 rdf:type acme:Claim)", "children_vertexes": [], "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "id": "?x2", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x2 is_good true)", "label": "(?clm01 is_good true)", "vertex": 4}], "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "id": "?x3", "label": "?clm02"}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x3 rdf:type acme:Claim)", "label": "(?clm02 rdf:type acme:Claim)", "vertex": 4, "parent_vertex": 3, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1", "?x3"]}}]}"""
    # print()
    # print('OPTIMIZED GOT:',json.dumps(optimized_data, indent=2))
    # print()
    # print('COMPACT:',json.dumps(optimized_data))
