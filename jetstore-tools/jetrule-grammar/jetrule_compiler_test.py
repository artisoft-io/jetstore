...
class JetRulesCompilerTest(absltest.TestCase):
  ...
  def test_compiler1(self):
    ...
    optimized_expected = """{"literals": [], "resources": [{"type": "resource", "id": "rdf:type", "value": "rdf:type"}, {"type": "resource", "id": "acme:Claim", "value": "acme:Claim"}, {"type": "volatile_resource", "id": "is_good", "value": "is_good"}], "lookup_tables": [], "jet_rules": [{"name": "RuleC4", "properties": {}, "authoredLabel": "[RuleC4]:(?clm01 rdf:type acme:Claim).[?clm01].(?clm01 is_good ?good).[?clm01 or true] -> (?clm01 is_good true);", "normalizedLabel": "[RuleC4]:(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1].(?x1 is_good ?x2) -> (?x1 is_good true);", "label": "[RuleC4]:(?clm01 rdf:type acme:Claim).[(?clm01 or true) and ?clm01].(?clm01 is_good ?good) -> (?clm01 is_good true);", "alpha_nodes": [{"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "label": "(?clm01 rdf:type acme:Claim).[(?clm01 or true) and ?clm01]", "filter": {"type": "binary", "lhs": {"type": "binary", "lhs": {"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}, "op": "or", "rhs": {"type": "keyword", "value": "true"}}, "op": "and", "rhs": {"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}}, "vertex": 1, "parent_vertex": 0, "beta_relation_vars": ["?x1"], "pruned_var": []}, "consequent_nodes": [], "children_vertexes": [2]}, {"vertex": 2, "parent_vertex": 1, "label": "(?x1 is_good ?x2)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": true}, {"type": "identifier", "value": "is_good"}, {"type": "var", "value": "?good", "id": "?x2", "label": "?good", "is_binded": false}], "normalizedLabel": "(?x1 is_good ?x2)", "label": "(?clm01 is_good ?good)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x1"], "pruned_var": ["?x2"]}, "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x1 is_good true)", "label": "(?clm01 is_good true)", "vertex": 2}], "children_vertexes": []}]}], "rete_nodes": [{"vertex": 0, "parent_vertex": 0, "label": "Head node", "antecedent_node": null, "consequent_nodes": [], "children_vertexes": [1]}, {"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim).[(?x1 or true) and ?x1]", "label": "(?clm01 rdf:type acme:Claim).[(?clm01 or true) and ?clm01]", "filter": {"type": "binary", "lhs": {"type": "binary", "lhs": {"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}, "op": "or", "rhs": {"type": "keyword", "value": "true"}}, "op": "and", "rhs": {"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": false}}, "vertex": 1, "parent_vertex": 0, "beta_relation_vars": ["?x1"], "pruned_var": []}, "consequent_nodes": [], "children_vertexes": [2]}, {"vertex": 2, "parent_vertex": 1, "label": "(?x1 is_good ?x2)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01", "is_binded": true}, {"type": "identifier", "value": "is_good"}, {"type": "var", "value": "?good", "id": "?x2", "label": "?good", "is_binded": false}], "normalizedLabel": "(?x1 is_good ?x2)", "label": "(?clm01 is_good ?good)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x1"], "pruned_var": ["?x2"]}, "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "value": "?clm01", "id": "?x1", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x1 is_good true)", "label": "(?clm01 is_good true)", "vertex": 2}], "children_vertexes": []}]}"""
    # print()
  ...
  # "label": "[RuleC5]:(?clm03 rdf:type acme:Claim).(?clm01 rdf:type acme:Claim).(?clm01 reverse_of ?clm02).(?clm02 rdf:type acme:Claim) -> (?clm01 is_good true);"    
    ...
    optimized_data = jetrule_ctx.jetRules
    optimized_expected = """{"literals": [], "resources": [{"type": "resource", "id": "rdf:type", "value": "rdf:type"}, {"type": "resource", "id": "acme:Claim", "value": "acme:Claim"}, {"type": "volatile_resource", "id": "is_good", "value": "is_good"}], "lookup_tables": [], "jet_rules": [{"name": "RuleC5", "properties": {}, "authoredLabel": "[RuleC5]:(?clm01 reverse_of ?clm02).(?clm03 rdf:type acme:Claim).(?clm01 rdf:type acme:Claim).(?clm02 rdf:type acme:Claim) -> (?clm01 is_good true);", "normalizedLabel": "[RuleC5]:(?x1 rdf:type acme:Claim).(?x2 rdf:type acme:Claim).(?x2 reverse_of ?x3).(?x3 rdf:type acme:Claim) -> (?x2 is_good true);", "label": "[RuleC5]:(?clm03 rdf:type acme:Claim).(?clm01 rdf:type acme:Claim).(?clm01 reverse_of ?clm02).(?clm02 rdf:type acme:Claim) -> (?clm01 is_good true);", "alpha_nodes": [{"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm03", "id": "?x1", "label": "?clm03", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim)", "label": "(?clm03 rdf:type acme:Claim)", "vertex": 1, "parent_vertex": 0, "beta_relation_vars": [], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [2]}, {"vertex": 2, "parent_vertex": 1, "label": "(?x2 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x2 rdf:type acme:Claim)", "label": "(?clm01 rdf:type acme:Claim)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [3]}, {"vertex": 3, "parent_vertex": 2, "label": "(?x2 reverse_of ?x3)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01", "is_binded": true}, {"type": "identifier", "value": "reverse_of"}, {"type": "var", "value": "?clm02", "id": "?x3", "label": "?clm02", "is_binded": false}], "normalizedLabel": "(?x2 reverse_of ?x3)", "label": "(?clm01 reverse_of ?clm02)", "vertex": 3, "parent_vertex": 2, "beta_relation_vars": ["?x2", "?x3"], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [4]}, {"vertex": 4, "parent_vertex": 3, "label": "(?x3 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm02", "id": "?x3", "label": "?clm02", "is_binded": true}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x3 rdf:type acme:Claim)", "label": "(?clm02 rdf:type acme:Claim)", "vertex": 4, "parent_vertex": 3, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1", "?x3"]}, "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x2 is_good true)", "label": "(?clm01 is_good true)", "vertex": 4}], "children_vertexes": []}]}], "rete_nodes": [{"vertex": 0, "parent_vertex": 0, "label": "Head node", "antecedent_node": null, "consequent_nodes": [], "children_vertexes": [1]}, {"vertex": 1, "parent_vertex": 0, "label": "(?x1 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm03", "id": "?x1", "label": "?clm03", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x1 rdf:type acme:Claim)", "label": "(?clm03 rdf:type acme:Claim)", "vertex": 1, "parent_vertex": 0, "beta_relation_vars": [], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [2]}, {"vertex": 2, "parent_vertex": 1, "label": "(?x2 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01", "is_binded": false}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x2 rdf:type acme:Claim)", "label": "(?clm01 rdf:type acme:Claim)", "vertex": 2, "parent_vertex": 1, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [3]}, {"vertex": 3, "parent_vertex": 2, "label": "(?x2 reverse_of ?x3)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01", "is_binded": true}, {"type": "identifier", "value": "reverse_of"}, {"type": "var", "value": "?clm02", "id": "?x3", "label": "?clm02", "is_binded": false}], "normalizedLabel": "(?x2 reverse_of ?x3)", "label": "(?clm01 reverse_of ?clm02)", "vertex": 3, "parent_vertex": 2, "beta_relation_vars": ["?x2", "?x3"], "pruned_var": ["?x1"]}, "consequent_nodes": [], "children_vertexes": [4]}, {"vertex": 4, "parent_vertex": 3, "label": "(?x3 rdf:type acme:Claim)", "antecedent_node": {"type": "antecedent", "isNot": false, "triple": [{"type": "var", "value": "?clm02", "id": "?x3", "label": "?clm02", "is_binded": true}, {"type": "identifier", "value": "rdf:type"}, {"type": "identifier", "value": "acme:Claim"}], "normalizedLabel": "(?x3 rdf:type acme:Claim)", "label": "(?clm02 rdf:type acme:Claim)", "vertex": 4, "parent_vertex": 3, "beta_relation_vars": ["?x2"], "pruned_var": ["?x1", "?x3"]}, "consequent_nodes": [{"type": "consequent", "triple": [{"type": "var", "value": "?clm01", "id": "?x2", "label": "?clm01"}, {"type": "identifier", "value": "is_good"}, {"type": "keyword", "value": "true"}], "normalizedLabel": "(?x2 is_good true)", "label": "(?clm01 is_good true)", "vertex": 4}], "children_vertexes": []}]}"""
    # print()
    # print('OPTIMIZED GOT:',json.dumps(optimized_data, indent=2))
    # print()
    # print('COMPACT:',json.dumps(optimized_data))
