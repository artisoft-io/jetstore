...
class JetRulesPostProcessorTest2(absltest.TestCase):
  ...
  def _get_augmented_data(self):
    ...
    compiler.processJetRuleFile("jet_listener_postprocessing_test_data.jr", provider)
  ...
  def test_rule_file1(self):
    jetRules = self._get_augmented_data()
    ...
    # with open("jetstore-tools/jetrule-grammar/jet_listener_postprocessing_test_data.jr.json", 'wt', encoding='utf-8') as f:
